...
> [!WARNING]
> **This branch is considered legacy.** minor bugfixes within reason to `main` are welcome, however TLEscope is currently being majorly revamped as part of the `extremelywip` branch.
>
> v4.0.0 is expected to release in Q4 2026.
...
<a href="https://www.star-history.com/?repos=aweeri%2Ftlescope&type=date&releases=&legend=bottom-right">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=aweeri/tlescope&type=date&releases=&theme=dark&legend=bottom-right" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=aweeri/tlescope&type=date&releases=&legend=bottom-right" />
