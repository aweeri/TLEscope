...
SRC          = src/main.cpp src/core/astro.cpp src/core/config.cpp src/core/theme.cpp src/core/location.cpp src/data/storage.cpp src/data/provider.cpp src/data/cache.cpp src/data/omm_parser.cpp src/ui/ui.cpp src/ui/ui_layout.cpp src/ui/imgui_theme.cpp src/io/rotator.cpp src/util/c23_compat.cpp src/util/log.cpp src/ui/tools/tools_registry.cpp src/ui/tools/tools_common.cpp $(wildcard src/ui/tools/tool_*.cpp)
