...
- The macOS app launcher now mirrors static system HTTP/HTTPS proxy settings, but PAC evaluation is unsupported. Document that limitation and add explicit/PAC proxy support only if it is a supported requirement.
